...
* [x] [4-7 图片验证码](./doc/4-7_图片验证码.md)
* [x] [4-8 图片验证码重构](./doc/4-8_图片验证码重构.md)
* [x] [4-9 添加记住我功能](./doc/4-9_添加记住我功能.md)
* [x] [4-10 短信验证码接口开发](./doc/4-10_短信验证码接口开发.md)
* [x] [4-11 短信登录开发](./doc/4-11_短信登录开发.md)
* [x] [4-12 短信登录配置及重构](./doc/4-12_短信登录配置及重构.md)
* [x] [4-13 小结](./doc/4-13_小结.md)

## 第5章 使用Spring Social开发第三方登录

* [x] [5-1 OAuth协议简介](./doc/5-1_OAuth协议简介.md)
* [x] [5-2 SpringSocial简介](./doc/5-2_SpringSocial简介.md)
